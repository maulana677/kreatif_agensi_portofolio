...
@section('content')
    <section class="section">
        ...
        <div class="card card-primary">
            ...
            @endphp
            <div class="card-body">
                <form action="{{ route('admin.footer-grid-four-title') }}" method="POST">
                    @csrf
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h4>All Footer grid four links</h4>
                <div class="card-header-action">
                    <a href="{{ route('admin.footer-grid-four.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($footer as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.footer-grid-four.edit', $item->id) }}"
                                            class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                        <a href="{{ route('admin.footer-grid-four.destroy', $item->id) }}"
