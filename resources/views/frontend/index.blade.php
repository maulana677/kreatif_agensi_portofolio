...
<body class="text-portto-black font-poppins">
            ...
            <div class="grid grid-cols-2 gap-[30px]">
                <div class="p-[50px] pb-0 rounded-[30px] flex flex-col gap-[50px] bg-[#F4F5F8]">
                    <div class="flex items-center justify-center shrink-0 w-20 h-20 rounded-full bg-portto-purple">
                        <img src="../assets/images/icons/crown.svg" class="w-10 h-10 object-contain" alt="icon">
                    </div>
                ...
                <div class="p-[50px] pb-0 rounded-[30px] flex flex-col gap-[50px] bg-[#F4F5F8]">
                    <div class="flex items-center justify-center shrink-0 w-20 h-20 rounded-full bg-portto-green">
                        <img src="../assets/images/icons/code.svg" class="w-10 h-10 object-contain" alt="icon">
                    </div>
                    <div class="flex flex-col gap-5">
                ...
                <div class="col-span-2 p-[50px] pb-0 rounded-[30px] flex gap-[50px] bg-[#F4F5F8]">
                    <div class="flex flex-col gap-[50px]">
                        <div class="flex items-center justify-center shrink-0 w-20 h-20 rounded-full bg-portto-red">
                            <img src="../assets/images/icons/3dcube.svg" class="w-10 h-10 object-contain"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-5">
                    ...
                    <div class="w-[450px] h-[350px] flex shrink-0">
                        <img src="../assets/images/services3.png" class="w-full object-contain" alt="image">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="w-[608px] h-[408px] rounded-[30px] overflow-hidden absolute">
                            <img src="../assets/images/thumbnails/thumbnail1.png" class="w-full h-full object-cover"
                                alt="thumbnail">
                        </div>
                        <div
                            ...
                            <div class="text-center z-10">
                                <p class="font-extrabold text-[32px] leading-[48px] mb-[10px] text-white">AI Finance
                                    SaaS <br>Website Integrations</p>
                    ...
                    <div
                        class="group w-[650px] h-[450px] flex shrink-0 rounded-[30px] border border-white p-5 bg-[#FFFFFF33] backdrop-blur relative">
                        <div class="w-[608px] h-[408px] rounded-[30px] overflow-hidden absolute">
                            <img src="../assets/images/thumbnails/thumbnail2.png" class="w-full h-full object-cover"
                                alt="thumbnail">
                        </div>
                        <div
                            class="flex flex-col w-full items-center justify-center gap-[50px] bg-portto-black rounded-[30px] relative opacity-0 hover:opacity-100 transition-all duration-300">
                    ...
                    <div
                        class="group w-[650px] h-[450px] flex shrink-0 rounded-[30px] border border-white p-5 bg-[#FFFFFF33] backdrop-blur relative">
                        <div class="w-[608px] h-[408px] rounded-[30px] overflow-hidden absolute">
                            <img src="../assets/images/thumbnails/thumbnail3.png" class="w-full h-full object-cover"
                                alt="thumbnail">
                        </div>
                        <div
                            class="flex flex-col w-full items-center justify-center gap-[50px] bg-portto-black rounded-[30px] relative opacity-0 hover:opacity-100 transition-all duration-300">
            ...
            <div class="flex flex-col gap-[30px] w-[603px] shrink-0">
                <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
                    <button class="accordion-button flex justify-between gap-1 items-center"
                        ...
                        <div class="arrow w-9 h-9 flex shrink-0">
                            <img src="../assets/images/icons/arrow-circle-down.svg"
                ...
                <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
                    ...
                    <div id="accordion-faq-3" class="accordion-content hide">
                        <p class="text-[20px] leading-[36px] pt-5">I don’t work full-time. At this moment, I prefer to
    ...
    <footer class="bg-portto-black text-white pb-[50px] border-t-[10px] border-portto-purple">
        <div
            ...
            <img src="../assets/images/Ellipse.svg" class="absolute h-[300px] top-[70px] -left-[20px] z-0"
                alt="icon">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <a href=""
                        class="font-medium hover:font-semibold hover:text-portto-light-gold transition-all duration-300 flex items-center gap-[6px]"><img
                            src="../assets/images/icons/call.svg" alt="icon">+1 2208 1996</a>
                    <a href=""
                        class="font-medium hover:font-semibold hover:text-portto-light-gold transition-all duration-300 flex items-center gap-[6px]"><img
                            src="../assets/images/icons/dribbble.svg" alt="icon">buildwithangga</a>
                    <a href=""
                        class="font-medium hover:font-semibold hover:text-portto-light-gold transition-all duration-300 flex items-center gap-[6px]"><img
                            src="../assets/images/icons/sms.svg" alt="icon">team@bwa.com</a>
                </div>
            </div>
        </div>
