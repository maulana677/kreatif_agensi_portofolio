    ...
    <section id="Header" class="flex flex-col gap-[100px] bg-portto-black relative max-h-[665px] mb-[493px]">
        ...
        <div class="hero container max-w-[1130px] mx-auto flex flex-col justify-center items-center relative">
            ...
            <div class="flex shrink-0 w-full h-[800px] rounded-[50px] overflow-hidden bg-white mt-[70px] z-10">
                <img src="{{ asset('frontend/assets/images/thumbnails/details-thumbnail.png') }}"
        ...
        <div class="flex gap-[50px] justify-between">
            <div class="flex flex-col gap-5">
                ...
                <div class="description flex flex-col gap-4 font-medium text-lg leading-[38px]">
                    <p>FinanceAI is a cutting-edge mobile application revolutionizing personal finance management through
                        artificial intelligence. This intuitive app is engineered to empower users with real-time financial
                        insights and personalized.</p>
                    <p>At the heart of FinanceAI lies a sophisticated AI engine that analyzes spending patterns, investment
                        choices, and saving habits to offer tailored recommendations. Whether it's optimizing budgets,
                        identifying investment opportunities, or potential savings, FinanceAI ensures users are always a
                        step ahead in their financial.</p>
                </div>
                ...
                <div class="software-container flex flex-col shrink-0 gap-5 w-[325px]">
                    <div
                        ...
                        <div class="w-[70px] h-[70px] bg-white rounded-full flex shrink-0 items-center justify-center">
                            <img src="{{ asset('frontend/assets/images/logos/react.svg') }}" alt="tool">
                        </div>
                    ...
                    <div
                        class="card-software w-full flex items-center bg-[#F4F5F8] rounded-2xl p-5 gap-4 transition-all duration-300 hover:ring-2 hover:ring-portto-purple">
                        <div class="w-[70px] h-[70px] bg-white rounded-full flex shrink-0 items-center justify-center">
                            <img src="{{ asset('frontend/assets/images/logos/blender.svg') }}" alt="tool">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                    ...
                    <div
                        class="card-software w-full flex items-center bg-[#F4F5F8] rounded-2xl p-5 gap-4 transition-all duration-300 hover:ring-2 hover:ring-portto-purple">
                        <div class="w-[70px] h-[70px] bg-white rounded-full flex shrink-0 items-center justify-center">
                            <img src="{{ asset('frontend/assets/images/logos/figma.svg') }}" alt="tool">
                        </div>
                        <div class="flex flex-col gap-[2px]">
    ...
    <section id="Screenshots" class="container max-w-[1130px] mx-auto pt-[50px]">
        <div class="flex flex-col gap-5">
            ...
            <div class="grid grid-cols-4 gap-5">
                <a href="{{ asset('frontend/assets/images/thumbnails/thumbnail1.png') }}"
                ...
                <a href="{{ asset('frontend/assets/images/thumbnails/thumbnail2.png') }}"
                    class="group w-full h-[190px] flex overflow-hidden rounded-[30px] ring-1 ring-[#E4E5E8] transition-all duration-300 hover:ring-[3px] hover:ring-portto-purple relative"
                    data-fancybox="gallery" data-caption="Screenshot #1">
                ...
                <a href="{{ asset('frontend/assets/images/thumbnails/thumbnail3.png') }}"
                    class="group w-full h-[190px] flex overflow-hidden rounded-[30px] ring-1 ring-[#E4E5E8] transition-all duration-300 hover:ring-[3px] hover:ring-portto-purple relative"
                    data-fancybox="gallery" data-caption="Screenshot #1">
            ...
            <div class="flex flex-col gap-[30px] w-[603px] shrink-0">
                <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
                    <button class="accordion-button flex justify-between gap-1 items-center"
                        ...
                        <div class="arrow w-9 h-9 flex shrink-0">
                            <img src="{{ asset('frontend/assets/images/icons/arrow-circle-down.svg') }}"
                                class="transition-all duration-300" alt="icon">
                        </div>
                    </button>
                    <div id="accordion-faq-1" class="accordion-content hide">
                        <p class="text-[20px] leading-[36px] pt-5">As a freelancer, my work process is characterized by
                ...
                <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
                    ...
                    <div id="accordion-faq-2" class="accordion-content hide">
                        <p class="text-[20px] leading-[36px] pt-5">I don’t charge hourly. I charge based on the project
                ...
                <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
                    ...
                    <div id="accordion-faq-3" class="accordion-content hide">
                        <p class="text-[20px] leading-[36px] pt-5">I don’t work full-time. At this moment, I prefer to work
                            remotely and based on the certain project only.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <a href=""
                        class="font-medium hover:font-semibold hover:text-portto-light-gold transition-all duration-300 flex items-center gap-[6px]"><img
                            src="{{ asset('frontend/assets/images/icons/call.svg') }}" alt="icon">+1 2208 1996</a>
                    <a href=""
                        class="font-medium hover:font-semibold hover:text-portto-light-gold transition-all duration-300 flex items-center gap-[6px]"><img
